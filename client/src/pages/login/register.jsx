...
import RegiterForm from "../../components/regiterform/regiterform.jsx";
...
const Register = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className="flex flex-col justify-center items-center lg:items-start lg:mt-0"
        >
          <img
            className="w-80 mt-6"
        ...
        <div  className={`${isLG ? "w-[60%]" : ""} relative`}>
          <RegiterForm />
          <Link
            to="/"
            className="w-[100%] text-center block p-4 cursor-pointer"
          >
